...
const Contact = () => {
  return (
    <section className="py-10 bg-gray-100 mt-20">
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full lg:w-1/2 px-4 mt-8 lg:mt-0">
            <div className="bg-white p-8 rounded-lg shadow-lg mt-16">
              ...
              <p className="text-gray-700 mb-2"><strong>Address:</strong> SM Street, Calicut, Kerala</p>
              <p className="text-gray-700 mb-2"><strong>Phone:</strong> 9876543210 | 0496-1234567</p>
              <p className="text-gray-700 mb-4"><strong>Email:</strong> contact@babybuds.com</p>
              <p className="text-gray-700"><strong>Business Hours:</strong> Mon-Sat 9:00 AM - 6:00 PM</p>
