...
const TopProducts = () => {
  ...
  return (
    <div className="shop-container mb-12 mt-20 px-4">
      <h1 className="text-4xl font-extrabold text-center mb-4 text-pink-500 tracking-wide">Our Top Rated Products</h1>
          ...
          <div key={product.id} className="p-4">
            <Link to={`/product/${product.id}`}>
              ...
              >
                ...
                <p className="text-center text-md font-semibold text-yellow-500 mb-2">⭐ {product.stars}</p>
