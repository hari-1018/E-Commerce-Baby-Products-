...
const TopProducts = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:5000/item')
      .then(response => {
        // Filter products that have stars greater than or equal to 4.5
  ...
  return (
    <div className="shop-container mb-12 mt-20 px-4">
      <h1 className="text-4xl font-extrabold text-center mb-4 text-pink-400 tracking-wide">Top Rated Products</h1>
