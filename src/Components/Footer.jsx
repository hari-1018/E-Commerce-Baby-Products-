...
const Footer = () => {
  return (
    <footer className="footer-container bg-pink-400 py-8">
      ...
      <div className="mt-8 text-center border-t border-gray-300 pt-4">
        <p className="text-sm font-bold mb-4  text-yellow-400 hover:text-blue-500">© 2024 BABY-BUDS. All rights reserved.</p>
      </div>
    </footer>
  );
};
