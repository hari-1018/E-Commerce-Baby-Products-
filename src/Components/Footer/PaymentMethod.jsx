  ...
  return (
    <div className="payment-methods p-6 bg-gray-100 rounded-lg shadow-lg max-w-7xl mt-20 mx-auto">
      ...
      <p className="text-gray-700 mb-6">
        At <strong className="text-blue-500">Baby Buds</strong>, we offer a variety of secure and convenient payment options to make your shopping experience as smooth as possible. Our payment methods are designed to cater to your preferences and ensure a hassle-free checkout process.
      </p>

      <h2 className="text-xl font-semibold mb-3 text-blue-500">Accepted Payment Methods</h2>
      <ul className="list-disc list-inside mb-6 text-gray-700">
        ...
        <li><strong>UPI:</strong> You can choose to pay via your UPI ids for a fast and secure transaction.</li>
      ...
      <h2 className="text-xl font-semibold mb-3 text-blue-500">Security & Privacy</h2>
      <p className="text-gray-700 mb-6">
      ...
      <h2 className="text-xl font-semibold mb-3 text-blue-500">Frequently Asked Questions</h2>
      <ul className="list-disc list-inside mb-6 text-gray-700">
